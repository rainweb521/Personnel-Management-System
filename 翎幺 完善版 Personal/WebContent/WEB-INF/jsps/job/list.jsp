...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <button id="aaa" type="button" onclick="location.href='${ctx}/job/add'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
      <a id="bbb" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/job/list" title="刷新">
    ...
    <div class="x-body">
     ...
     <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  href='${ctx}/job/edit?id=${dept.id}'>
     ...
     <div style="margin-left: 400px;">
         <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/job/list?pageIndex={0}"/>
     </div> --%>
