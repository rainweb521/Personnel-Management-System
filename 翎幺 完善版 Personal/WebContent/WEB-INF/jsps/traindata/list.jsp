  ...
  <body>
      ...
      <span class="layui-breadcrumb">
        ...
        <a>
          <cite>培训资源</cite></a>
            ...
            <button id="aaa" type="button" onclick="location.href='${ctx}/traindata/add'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  lay-submit="" lay-filter="sreach"><i class="layui-icon"></i>增加</button>
      
      <a id="bbb" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/traindata/list" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
    </div>
    <div class="x-body">
      <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${ctx }/traindata/list">
     ...
     <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  href='${ctx}/traindata/edit?id=${dept.id}'>
    ...
    function openVideo(filename) {
        ...
        var index = layer.open({
            type: 2,
            content: '${ctx}/traindata/play?filename='+classVideo,  //  视频播放页面
            area: ['600px', '450px'],
            offset:'t',
            maxmin: true,
            end: function () {
     ...
     <div style="margin-left: 400px;" id="count1">
         <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/traindata/list?pageIndex={0}"/>
     </div>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              //等以后再使用异步，这里先使用
              $.get("${ctx}/traindata/delete?id="+id);
