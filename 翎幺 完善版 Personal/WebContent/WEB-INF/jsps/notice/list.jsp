  ...
  <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        ...
        <a>
         ...
         <button id="bbb" type="button"  onclick="location.href='${ctx}/notice/add'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
    ...
    <div class="x-body">
     ...
     <tr>
            ...
            <td class="td-manage" >
               <a title="编辑"  href='${ctx}/notice/edit?id=${dept.id}'>
     ...
     <div style="margin-left: 400px;" id="count1">
         <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${ctx}/notice/list?pageIndex={0}"/>
     </div>
